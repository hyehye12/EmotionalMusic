...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-8 font-sans bg-gray-50">
      <div className="modern-card p-12 w-full max-w-md relative">
        <div className="text-center mb-8">
          <div className="w-16 h-16 mx-auto bg-blue-600 rounded-full flex items-center justify-center text-white text-2xl mb-4">
            🔐
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full soft-button py-3 rounded-lg font-medium text-lg disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loading ? (
        ...
        <div className="mt-8 text-center">
          <button
            type="button"
            onClick={() => navigate('/')}
            className="px-6 py-3 text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors flex items-center justify-center space-x-2 mx-auto"
          >
            <span>←</span>
            <span>홈으로 돌아가기</span>
          </button>
